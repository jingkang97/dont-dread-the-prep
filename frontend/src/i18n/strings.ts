...
export const EN = {
  ...
  'tour.5d': 'Home, timeline, food, stool, and contacts — same places as the cards above.',
  ...
  'stool.remindersBody': 'Timed to your timeline, on Telegram or as an app push notification.',
  'stool.ready': 'Ready',
  'stool.almost': 'Almost',
  ...
  'wa.sandboxBodyOn': 'This chat is linked. Timeline reminders will arrive here.',
  'wa.joinWord': 'Bot',
  ...
  'wa.pushBody': 'Timeline reminders and each hospital prep dose, as an app push notification.',
  ...
  'wa.pushUnsupported': 'This browser cannot receive app notifications. Use Telegram instead.',
  ...
  'pitch.1d': 'Hospital, date, and reporting time. Then a countdown to the scope.',

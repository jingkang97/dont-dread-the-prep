...
export const EN = {
  ...
  'home.shortcutImgIos': 'Safari Share button at the bottom and Add to Home Screen',
  'home.shortcutImgIosNew': 'Safari address-bar menu, Share, and Add to Home Screen',

...
export const EN = {
  ...
  'home.waBody':
    'App notifications or Telegram. Timed to your timeline — meds, diet, prep doses, stool check, and fasting.',
  ...
  'tour.3t': 'Reminders',
  'tour.3d': 'App notifications or Telegram. Timed to your timeline — meds, diet, prep, stool, and fasting.',
  ...
  'stool.remindersBody': 'Timed to your timeline, on Telegram or as an app notification.',
  'stool.ready': 'Ready',
  'stool.almost': 'Almost',
  ...
  'wa.welcomeBody':
    'Pick app notifications, Telegram, or both. Reminders follow your timeline — medicines, diet, each prep dose, a stool check, and when to stop fluids.',
  'wa.welcomeBodyDemo':
  ...
  'wa.pushTitle': 'App notification',
  'wa.pushBody': 'Timeline reminders and each hospital prep dose, as an app notification.',
  'wa.pushAllow': 'Allow notifications',
  'wa.on': 'On',
  'wa.pushOn': 'App notifications on.',
  'wa.pushOff': 'Turn off',
  'wa.pushNeedInstall':

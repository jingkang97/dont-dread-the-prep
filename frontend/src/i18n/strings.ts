...
export const EN = {
  ...
  'food.introBody':
    'Ask in plain language. I only classify against your hospital’s sheet using six rules. I will not invent diet advice. Named local foods (prata, kopi, thosai) stay in those names.',
  'food.send': 'Send',

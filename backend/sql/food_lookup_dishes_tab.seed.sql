...
--   DIETICIAN  225 dishes, 131 distinct ingredient names: 131 on tier,  0 via DIETICIAN, 0 unresolved
--   TTSH        58 dishes,  58 distinct ingredient names:  40 on tier, 18 via DIETICIAN, 0 unresolved
--   SKH         58 dishes,  58 distinct ingredient names:  47 on tier, 11 via DIETICIAN, 0 unresolved
--
-- Every id here resolves. The 22 names the Sept 18 sheet does not carry (Pork,
-- Butter, Cooking oil, Plain prata …) are restored on all three tiers at the end
-- of food_lookup_ingredient_tab.seed.sql, so no dish is stored with a null id
-- and no verdict is computed from a partial ingredient list. Earlier revisions
-- wrote {"id": null} for those names, which _resolve_ingredients() skipped —
-- Kaya toast then computed 'can' on white bread alone, its butter unseen.
--
-- Names restored rather than carried by the sheet (ids 384..442; SKH already had 7)
--   Bandung, Beef, Butter, Calamansi drink, Chin chow drink, Coconut flesh,
--   Coconut water, Cooking oil, Duck, Mutton / lamb, Plain biscuits,
--   Plain crackers, Plain naan, Plain pancake, Plain prata, Plain waffle, Pork,
--   Rice cereal, Sugarcane juice, Tempeh, Unlisted extras (recipe varies),
--   Vegetarian mock meat
--   4 classify 'can', 8 'cannot', 10 'review' — so most of them now read as an
--   ingredient to leave out, which is why several dishes drop off meal prep.
--
...
VALUES
  ...
  ('Pork', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 400, "name": "Pork"}]'::jsonb, false, ''),
  ('Beef', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 385, "name": "Beef"}]'::jsonb, false, ''),
  ('Mutton / lamb', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 393, "name": "Mutton / lamb"}]'::jsonb, false, ''),
  ('Duck', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 392, "name": "Duck"}]'::jsonb, false, ''),
  ...
  ('Vegetarian mock meat', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 405, "name": "Vegetarian mock meat"}]'::jsonb, false, ''),
  ...
  ('Tempeh', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 403, "name": "Tempeh"}]'::jsonb, false, ''),
  ...
  ('Sugarcane juice', ARRAY['drink']::dish_meal_type[], 'DIETICIAN', '[{"id": 402, "name": "Sugarcane juice"}]'::jsonb, false, ''),
  ('Calamansi drink', ARRAY['drink']::dish_meal_type[], 'DIETICIAN', '[{"id": 387, "name": "Calamansi drink"}]'::jsonb, false, ''),
  ('Coconut water', ARRAY['drink']::dish_meal_type[], 'DIETICIAN', '[{"id": 390, "name": "Coconut water"}]'::jsonb, false, ''),
  ...
  ('Chin chow drink', ARRAY['drink']::dish_meal_type[], 'DIETICIAN', '[{"id": 388, "name": "Chin chow drink"}]'::jsonb, false, ''),
  ...
  ('Roast duck rice', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 392, "name": "Duck"}, {"id": 39, "name": "Cucumber"}, {"id": 42, "name": "Dark soy sauce"}]'::jsonb, false, ''),
  ('Char siu rice', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 400, "name": "Pork"}, {"id": 39, "name": "Cucumber"}]'::jsonb, false, ''),
  ('Economic rice / cai png', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 404, "name": "Unlisted extras (recipe varies)"}]'::jsonb, false, ''),
  ...
  ('Hokkien mee', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 165, "name": "Yellow noodles"}, {"id": 8, "name": "Bee hoon"}, {"id": 110, "name": "Prawns"}, {"id": 136, "name": "Squid"}, {"id": 400, "name": "Pork"}, {"id": 7, "name": "Bean sprouts"}, {"id": 135, "name": "Spring onion"}, {"id": 120, "name": "Sambal"}]'::jsonb, true, 'Deep-fried — the oil makes this unsuitable for prep no matter what goes into it.'),
  ('Prawn mee', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 165, "name": "Yellow noodles"}, {"id": 8, "name": "Bee hoon"}, {"id": 110, "name": "Prawns"}, {"id": 400, "name": "Pork"}, {"id": 7, "name": "Bean sprouts"}, {"id": 71, "name": "Kang kong"}, {"id": 26, "name": "Chilli"}, {"id": 54, "name": "Fried shallots"}]'::jsonb, false, ''),
  ...
  ('Bak chor mee', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 86, "name": "Mee pok"}, {"id": 85, "name": "Mee kia"}, {"id": 400, "name": "Pork"}, {"id": 48, "name": "Fishball"}, {"id": 92, "name": "Mushrooms"}, {"id": 81, "name": "Lettuce"}, {"id": 26, "name": "Chilli"}, {"id": 135, "name": "Spring onion"}, {"id": 54, "name": "Fried shallots"}]'::jsonb, false, ''),
  ('Wanton noodles', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 165, "name": "Yellow noodles"}, {"id": 400, "name": "Pork"}, {"id": 27, "name": "Chye sim"}, {"id": 26, "name": "Chilli"}, {"id": 135, "name": "Spring onion"}]'::jsonb, false, ''),
  ('Lor mee', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 165, "name": "Yellow noodles"}, {"id": 44, "name": "Egg"}, {"id": 49, "name": "Fishcake"}, {"id": 400, "name": "Pork"}, {"id": 7, "name": "Bean sprouts"}, {"id": 26, "name": "Chilli"}, {"id": 36, "name": "Coriander"}, {"id": 56, "name": "Garlic"}]'::jsonb, false, ''),
  ('Beef hor fun', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 76, "name": "Kway teow"}, {"id": 385, "name": "Beef"}, {"id": 70, "name": "Kai lan"}, {"id": 27, "name": "Chye sim"}, {"id": 135, "name": "Spring onion"}]'::jsonb, false, ''),
  ...
  ('Chicken soup', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 24, "name": "Chicken"}, {"id": 28, "name": "Clear chicken broth"}, {"id": 404, "name": "Unlisted extras (recipe varies)"}]'::jsonb, false, ''),
  ...
  ('Century egg porridge', ARRAY['breakfast']::dish_meal_type[], 'DIETICIAN', '[{"id": 156, "name": "White porridge"}, {"id": 44, "name": "Egg"}, {"id": 400, "name": "Pork"}, {"id": 135, "name": "Spring onion"}, {"id": 57, "name": "Ginger"}, {"id": 132, "name": "Soy sauce"}, {"id": 54, "name": "Fried shallots"}]'::jsonb, false, ''),
  ...
  ('Bak kut teh', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 400, "name": "Pork"}, {"id": 56, "name": "Garlic"}, {"id": 36, "name": "Coriander"}]'::jsonb, false, ''),
  ('Pig organ soup', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 400, "name": "Pork"}, {"id": 135, "name": "Spring onion"}]'::jsonb, false, ''),
  ...
  ('Black pepper beef', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 385, "name": "Beef"}, {"id": 96, "name": "Onion"}]'::jsonb, false, ''),
  ('Beef noodles', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 165, "name": "Yellow noodles"}, {"id": 385, "name": "Beef"}, {"id": 135, "name": "Spring onion"}]'::jsonb, false, ''),
  ('Kway chap', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 76, "name": "Kway teow"}, {"id": 400, "name": "Pork"}, {"id": 42, "name": "Dark soy sauce"}, {"id": 54, "name": "Fried shallots"}]'::jsonb, false, ''),
  ('Roast meats platter', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 400, "name": "Pork"}, {"id": 392, "name": "Duck"}, {"id": 24, "name": "Chicken"}, {"id": 39, "name": "Cucumber"}]'::jsonb, false, ''),
  ('Har gow', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 110, "name": "Prawns"}, {"id": 404, "name": "Unlisted extras (recipe varies)"}]'::jsonb, false, ''),
  ('Siew mai', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 400, "name": "Pork"}, {"id": 110, "name": "Prawns"}, {"id": 404, "name": "Unlisted extras (recipe varies)"}]'::jsonb, false, ''),
  ...
  ('Rojak', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 147, "name": "Tofu"}, {"id": 391, "name": "Cooking oil"}, {"id": 39, "name": "Cucumber"}, {"id": 106, "name": "Pineapple"}, {"id": 102, "name": "Peanuts"}]'::jsonb, false, ''),
  ('Satay', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 24, "name": "Chicken"}, {"id": 400, "name": "Pork"}, {"id": 385, "name": "Beef"}, {"id": 393, "name": "Mutton / lamb"}, {"id": 39, "name": "Cucumber"}, {"id": 96, "name": "Onion"}, {"id": 102, "name": "Peanuts"}]'::jsonb, false, ''),
  ...
  ('Cereal prawns', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 391, "name": "Cooking oil"}, {"id": 110, "name": "Prawns"}, {"id": 26, "name": "Chilli"}, {"id": 386, "name": "Butter"}]'::jsonb, true, 'Deep-fried — the oil makes this unsuitable for prep no matter what goes into it.'),
  ('Ngoh hiang', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 400, "name": "Pork"}, {"id": 110, "name": "Prawns"}, {"id": 96, "name": "Onion"}]'::jsonb, true, 'Deep-fried — the oil makes this unsuitable for prep no matter what goes into it.'),
  ...
  ('Ayam penyet', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 24, "name": "Chicken"}, {"id": 391, "name": "Cooking oil"}, {"id": 39, "name": "Cucumber"}, {"id": 18, "name": "Cabbage"}, {"id": 120, "name": "Sambal"}]'::jsonb, false, ''),
  ...
  ('Sup tulang', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 155, "name": "White bread"}, {"id": 157, "name": "White rice"}, {"id": 393, "name": "Mutton / lamb"}, {"id": 96, "name": "Onion"}, {"id": 148, "name": "Tomato"}, {"id": 40, "name": "Curry paste"}]'::jsonb, false, ''),
  ('Beef rendang', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 385, "name": "Beef"}, {"id": 33, "name": "Coconut milk"}, {"id": 40, "name": "Curry paste"}]'::jsonb, false, ''),
  ...
  ('Begedil', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 109, "name": "Potato"}, {"id": 44, "name": "Egg"}, {"id": 400, "name": "Pork"}, {"id": 96, "name": "Onion"}]'::jsonb, true, 'Deep-fried — the oil makes this unsuitable for prep no matter what goes into it.'),
  ('Egg prata', ARRAY['breakfast']::dish_meal_type[], 'DIETICIAN', '[{"id": 398, "name": "Plain prata"}, {"id": 44, "name": "Egg"}, {"id": 40, "name": "Curry paste"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ('Onion prata', ARRAY['breakfast']::dish_meal_type[], 'DIETICIAN', '[{"id": 398, "name": "Plain prata"}, {"id": 96, "name": "Onion"}, {"id": 40, "name": "Curry paste"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ('Cheese prata', ARRAY['breakfast']::dish_meal_type[], 'DIETICIAN', '[{"id": 398, "name": "Plain prata"}, {"id": 22, "name": "Cheese"}, {"id": 40, "name": "Curry paste"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ...
  ('Idiyappam / putu mayam', ARRAY['breakfast']::dish_meal_type[], 'DIETICIAN', '[{"id": 8, "name": "Bee hoon"}, {"id": 33, "name": "Coconut milk"}, {"id": 389, "name": "Coconut flesh"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ...
  ('Naan', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 155, "name": "White bread"}, {"id": 386, "name": "Butter"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ...
  ('Biryani', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 157, "name": "White rice"}, {"id": 24, "name": "Chicken"}, {"id": 393, "name": "Mutton / lamb"}, {"id": 96, "name": "Onion"}, {"id": 166, "name": "Yoghurt"}, {"id": 391, "name": "Cooking oil"}]'::jsonb, false, ''),
  ('Murtabak', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 393, "name": "Mutton / lamb"}, {"id": 24, "name": "Chicken"}, {"id": 96, "name": "Onion"}, {"id": 40, "name": "Curry paste"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ('Indian mee goreng', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 165, "name": "Yellow noodles"}, {"id": 44, "name": "Egg"}, {"id": 400, "name": "Pork"}, {"id": 18, "name": "Cabbage"}, {"id": 148, "name": "Tomato"}, {"id": 26, "name": "Chilli"}, {"id": 150, "name": "Tomato ketchup"}, {"id": 135, "name": "Spring onion"}]'::jsonb, true, 'Deep-fried — the oil makes this unsuitable for prep no matter what goes into it.'),
  ...
  ('Kaya toast', ARRAY['breakfast']::dish_meal_type[], 'DIETICIAN', '[{"id": 155, "name": "White bread"}, {"id": 72, "name": "Kaya"}, {"id": 386, "name": "Butter"}]'::jsonb, false, ''),
  ...
  ('Tau huay', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 147, "name": "Tofu"}, {"id": 404, "name": "Unlisted extras (recipe varies)"}]'::jsonb, false, ''),
  ('Mango pudding', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 83, "name": "Mango"}, {"id": 52, "name": "Fresh milk"}, {"id": 38, "name": "Cream"}]'::jsonb, false, ''),
  ('Onde-onde', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 389, "name": "Coconut flesh"}]'::jsonb, false, ''),
  ('Ang ku kueh', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 91, "name": "Mung beans"}, {"id": 102, "name": "Peanuts"}, {"id": 391, "name": "Cooking oil"}]'::jsonb, false, ''),
  ('Steamed rice kueh (plain)', ARRAY['snack']::dish_meal_type[], 'DIETICIAN', '[{"id": 404, "name": "Unlisted extras (recipe varies)"}]'::jsonb, false, ''),
  ...
  ('Chin chow', ARRAY['drink']::dish_meal_type[], 'DIETICIAN', '[{"id": 388, "name": "Chin chow drink"}]'::jsonb, false, ''),
  ...
  ('Wonton soup', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 400, "name": "Pork"}, {"id": 110, "name": "Prawns"}, {"id": 28, "name": "Clear chicken broth"}, {"id": 135, "name": "Spring onion"}]'::jsonb, false, ''),
  ('Plain steamed egg', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 44, "name": "Egg"}, {"id": 132, "name": "Soy sauce"}]'::jsonb, false, ''),
  ('Omelette', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 44, "name": "Egg"}, {"id": 96, "name": "Onion"}, {"id": 391, "name": "Cooking oil"}]'::jsonb, false, ''),
  ('Fried chicken', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 24, "name": "Chicken"}, {"id": 391, "name": "Cooking oil"}]'::jsonb, true, 'Deep-fried — the oil makes this unsuitable for prep no matter what goes into it.'),
  ...
  ('Plain pasta', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 101, "name": "Pasta"}, {"id": 391, "name": "Cooking oil"}, {"id": 386, "name": "Butter"}]'::jsonb, false, ''),
  ...
  ('Fish and chips', ARRAY['lunch', 'dinner']::dish_meal_type[], 'DIETICIAN', '[{"id": 109, "name": "Potato"}, {"id": 47, "name": "Fish"}, {"id": 391, "name": "Cooking oil"}]'::jsonb, true, 'Deep-fried — the oil makes this unsuitable for prep no matter what goes into it.'),
  ...
  ('Plain crackers', ARRAY['breakfast', 'snack']::dish_meal_type[], 'TTSH', '[{"id": 432, "name": "Plain crackers"}]'::jsonb, false, ''),
  ('Plain biscuits', ARRAY['breakfast', 'snack']::dish_meal_type[], 'TTSH', '[{"id": 431, "name": "Plain biscuits"}]'::jsonb, false, ''),
  ('Rice cereal', ARRAY['breakfast', 'snack']::dish_meal_type[], 'TTSH', '[{"id": 438, "name": "Rice cereal"}]'::jsonb, false, ''),
  ...
  ('Plain prata', ARRAY['breakfast']::dish_meal_type[], 'TTSH', '[{"id": 435, "name": "Plain prata"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ('Plain naan', ARRAY['breakfast']::dish_meal_type[], 'TTSH', '[{"id": 433, "name": "Plain naan"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ('Plain pancake', ARRAY['breakfast']::dish_meal_type[], 'TTSH', '[{"id": 434, "name": "Plain pancake"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ('Plain waffle', ARRAY['breakfast']::dish_meal_type[], 'TTSH', '[{"id": 436, "name": "Plain waffle"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ...
  ('Cooking oil', ARRAY['breakfast', 'lunch', 'dinner']::dish_meal_type[], 'TTSH', '[{"id": 428, "name": "Cooking oil"}]'::jsonb, false, ''),
  ('Butter', ARRAY['breakfast', 'lunch', 'dinner']::dish_meal_type[], 'TTSH', '[{"id": 423, "name": "Butter"}]'::jsonb, false, ''),
  ...
  ('Coconut flesh', ARRAY['breakfast', 'lunch', 'dinner']::dish_meal_type[], 'TTSH', '[{"id": 426, "name": "Coconut flesh"}]'::jsonb, false, ''),
  ...
  ('Bandung', ARRAY['drink']::dish_meal_type[], 'TTSH', '[{"id": 421, "name": "Bandung"}]'::jsonb, false, ''),
  ...
  ('Plain crackers', ARRAY['breakfast', 'snack']::dish_meal_type[], 'SKH', '[{"id": 414, "name": "Plain crackers"}]'::jsonb, false, ''),
  ...
  ('Plain prata', ARRAY['breakfast']::dish_meal_type[], 'SKH', '[{"id": 417, "name": "Plain prata"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ('Plain naan', ARRAY['breakfast']::dish_meal_type[], 'SKH', '[{"id": 415, "name": "Plain naan"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ('Plain pancake', ARRAY['breakfast']::dish_meal_type[], 'SKH', '[{"id": 416, "name": "Plain pancake"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ('Plain waffle', ARRAY['breakfast']::dish_meal_type[], 'SKH', '[{"id": 418, "name": "Plain waffle"}]'::jsonb, true, 'Cooked in oil or ghee on the griddle — too rich for prep even when plain.'),
  ...
  ('Cooking oil', ARRAY['breakfast', 'lunch', 'dinner']::dish_meal_type[], 'SKH', '[{"id": 412, "name": "Cooking oil"}]'::jsonb, false, ''),
  ('Butter', ARRAY['breakfast', 'lunch', 'dinner']::dish_meal_type[], 'SKH', '[{"id": 407, "name": "Butter"}]'::jsonb, false, ''),
  ...
  ('Coconut flesh', ARRAY['breakfast', 'lunch', 'dinner']::dish_meal_type[], 'SKH', '[{"id": 410, "name": "Coconut flesh"}]'::jsonb, false, ''),
  ...
  ('Bandung', ARRAY['drink']::dish_meal_type[], 'SKH', '[{"id": 406, "name": "Bandung"}]'::jsonb, false, ''),

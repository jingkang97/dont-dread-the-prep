-- Bristol (fallback for hospitals with no chart) + TTSH 6-point colour scale.
-- Depends on: mvp.sql, mvp.seed.sql, stool_scales.sql.
-- Safe to re-run.
--
-- TTSH points at ttsh-6. SGH / NCCS stay null → API resolves to Bristol.
...
JOIN (
  VALUES
    ('ttsh-6', 1, 'Solid lumps', 'Dark, thick, formed stool', 'not', '#5c3a24', 'ttsh/s1.png'),
    ('ttsh-6', 2, 'Soft blobs', 'Brown, thick, still has stool material', 'not', '#7a4a28', 'ttsh/s2.png'),
    ('ttsh-6', 3, 'Cloudy brown', 'Dark brown liquid with particles', 'not', '#8a5a2a', 'ttsh/s3.png'),
    ('ttsh-6', 4, 'Dark liquid', 'Dark orange / brown, semi-clear', 'not', '#c47a2b', 'ttsh/s4.png'),
    ('ttsh-6', 5, 'Light orange', 'Almost clear, light orange', 'almost', '#e2a04a', 'ttsh/s5.png'),
    ('ttsh-6', 6, 'Clear yellow', 'Yellow, light, watery, no particles', 'ready', '#e6c35c', 'ttsh/s6.png'),

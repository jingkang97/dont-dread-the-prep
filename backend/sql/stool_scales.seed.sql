...
JOIN (
  VALUES
    ('ttsh-6', 1, 'Solid lumps', NULL::text, 'not', '#5c3a24', 'ttsh/s1.png'),
    ('ttsh-6', 2, 'Soft blobs', NULL, 'not', '#7a4a28', 'ttsh/s2.png'),
    ('ttsh-6', 3, 'Cloudy brown', NULL, 'not', '#8a5a2a', 'ttsh/s3.png'),
    ('ttsh-6', 4, 'Dark liquid', NULL, 'not', '#c47a2b', 'ttsh/s4.png'),
    ('ttsh-6', 5, 'Light orange', NULL, 'almost', '#e2a04a', 'ttsh/s5.png'),
    ('ttsh-6', 6, 'Clear yellow', NULL, 'ready', '#e6c35c', 'ttsh/s6.png'),
    ('skh-6', 1, 'Dark with materials', NULL, 'not', '#3b2418', 'skh/1.png'),
    ('skh-6', 2, 'Brown with materials', NULL, 'not', '#6b3f24', 'skh/2.png'),
    ('skh-6', 3, 'Dark orange', NULL, 'not', '#c45f18', 'skh/3.png'),
    ('skh-6', 4, 'Light orange', NULL, 'almost', '#e8993a', 'skh/4.png'),
    ('skh-6', 5, 'Pale orange', NULL, 'almost', '#f0b45a', 'skh/5.png'),
    ('skh-6', 6, 'Clear yellow', NULL, 'ready', '#e6c35c', 'skh/6.png'),
